...
* Replace unexpected technical errors with a generic administrator message.
...
controls and replace unexpected server or client errors with a generic message.
